    ...
    return Opacity(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          backgroundColor: widget.type=="sales"?P_Settings.wavecolor:P_Settings.returnbuttnColor,
          actions: <Widget>[
            IconButton(
              icon: Icon(
                Icons.shopping_cart,
                  ...
                  child: Container(
                      ...
                      child: value.isLoading
                          ? Center(
                              ...
                              color: widget.type=="sales"? P_Settings.wavecolor:P_Settings.returnbuttnColor,
                              size: 15,
                            ))
                          : Text(
                              widget.type == "sales"
                      ...
                      decoration: BoxDecoration(
                        color:widget.type=="sales"? P_Settings.roundedButtonColor:P_Settings.returncountColor,
